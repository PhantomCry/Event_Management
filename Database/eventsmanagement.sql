...
CREATE TABLE `document` (
  ...
  CONSTRAINT `iddocument` FOREIGN KEY (`iddocument`) REFERENCES `elements` (`elementID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `elements` (
  ...
  `etype` enum('text','document','media') NOT NULL,
  `fieldID` int(11) NOT NULL,
  PRIMARY KEY (`elementID`),
  KEY `fieldID` (`fieldID`),
  CONSTRAINT `fieldID` FOREIGN KEY (`fieldID`) REFERENCES `fields` (`idfield`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gallery` (
  ...
  CONSTRAINT `belongsTo` FOREIGN KEY (`belongsTo`) REFERENCES `events` (`idevents`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `media` (
  ...
  `media` blob NOT NULL,
  PRIMARY KEY (`idmedia`),
  CONSTRAINT `idmedia` FOREIGN KEY (`idmedia`) REFERENCES `elements` (`elementID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `text` (
  ...
  PRIMARY KEY (`idtext`),
  CONSTRAINT `idtext` FOREIGN KEY (`idtext`) REFERENCES `elements` (`elementID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-05-05 10:54:30
